...
public class Agregar_carro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fotos.add(R.drawable.bentli);
        fotos.add(R.drawable.chevrolet);
        fotos.add(R.drawable.lamborguini);
        fotos.add(R.drawable.mustang);
        fotos.add(R.drawable.porsche);
        fotos.add(R.drawable.susuki);
    }
    ...
    public void onBackPressed() {
        finish();
        Intent i = new Intent(Agregar_carro.this, Pricipal.class);
        startActivity(i);
    }
